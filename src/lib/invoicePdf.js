// src/lib/invoicePdf.js (utilisé aussi côté /api via require compatible)
// Génère un PDF de facture fidèle au modèle "MARIEM GUEST SERVICES"
// fourni : en-tête sombre, bandeau or pour le total, tableaux de détails.
